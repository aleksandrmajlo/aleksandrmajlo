...
function  _findCountryCode (tags) {
...
function formatHit(_ref) {
  ...
  try {
    ...
    var _ref2 = hit.postcode && hit.postcode.length ? getBestPostcode(hit.postcode, hit._highlightResult.postcode) : {
      ...
      console.log(hit._highlightResult.locale_names)
      console.log(getBestHighlightedForm(hit._highlightResult.locale_names))
      console.log('name')
      return 1;
