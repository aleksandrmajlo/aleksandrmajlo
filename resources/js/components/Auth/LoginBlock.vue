<template>
    <div class="dropdown dropdown--js">
        <div v-if="!$auth.check()||!check">
            <router-link to="/login" class="dropdown__toggle">
            ...
            <div class="dropdown__block dropdown__block--form" :class="{active:isLogin}">
                <div class="form-wrap">
                    ...
                    <form autocomplete="off" @submit.prevent="login" method="post">
                        ...
                        <button class="btn btn-primary btn-block mb-2" type="submit">{{$t('login_button_send')}}</button>
                        <router-link
        ...
        <div v-else>
            <router-link to="/account" class="dropdown__toggle">
                <svg class="icon icon-user">
                    <use xlink:href="/img/svg/sprite.svg#user"/>
                </svg>
            </router-link>
